    ...
    return (
        <VerticalTimeline>
            <VerticalTimelineElement
                ...
                // icon={<WorkIcon />}
            >
                <h3 className="vertical-timeline-element-title" style={{ color: '#F2EDE9' }}>Attending Stevens Institute of Technology</h3>
            ...
            <VerticalTimelineElement
                ...
                // icon={<WorkIcon />}
            >
                <h3 className="vertical-timeline-element-title" style={{ color: '#F2EDE9' }}>iThreat Cyber Group</h3>
                {/* <h4 className="vertical-timeline-element-subtitle">Miami, FL</h4> */}
                <p style={{ color: '#F2EDE9' }}>
            ...
            <VerticalTimelineElement
                ...
                // icon={<WorkIcon />}
            >
                <h3 className="vertical-timeline-element-title" style={{ color: '#F2EDE9' }}>Marsh & McLennan Companies</h3>
                {/* <h4 className="vertical-timeline-element-subtitle">Miami, FL</h4> */}
                <p style={{ color: '#F2EDE9' }}>
            ...
            <VerticalTimelineElement
                ...
                // icon={<WorkIcon />}
            >
                <h3 className="vertical-timeline-element-title" style={{ color: '#F2EDE9' }}>Graduated Stevens Institute of Technology <br></br><br></br></h3>
                <h5 style={{ color: '#F2EDE9' }}>B.E. Software Engineering</h5>
                {/* <h4 className="vertical-timeline-element-subtitle">Miami, FL</h4> */}
                <p style={{ color: '#F2EDE9' }}>
                    Joined the HRIS team as a SharePoint Content Administrator where I was responsible for redesigning existing and building new community sites within the SharePoint environment.
                </p>
